  ...
  try {
    ...
    if (req.body.password === req.body.passwordConfrim) {
      ...
      const transporter = nodemailer.createTransport({
        service: "Gmail",
        auth: {
          user: "sandeepjaat3629@gmail.com",
          pass: "fuaiodniyrlazcaj",
        },
      });

      const mailOptions = {
        from: "MoonLight Cafe <sandeepjaat3629@gmail.com>",
        to: req.body.email,
        subject: "OTP for Email Verification",
        html: `
    <p>Hello,</p>
    <p>Thank you for registering with MoonLight . To complete your email verification, please use the following One-Time Password (OTP):</p>
