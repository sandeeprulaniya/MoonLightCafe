    ...
    <div className='flex items-center hover:bg-gray-100 -mx-8 px-6 py-5 '>
        <div className='flex w-2/5'>
            ...
            <div className='flex flex-col justify-between  ml-4 flex-grow'>
                ...
                <span className='flex items-center  space-x-4'>
                    {/* <div onClick={() => removeItem(food)} className='shadow-sm text-white bg-red-500 hover:bg-red-700 cursor-pointer p-4 rounded-full relative'>
                    ...
                    <div onClick={() => addToCart(food)} className='shadow-sm text-white bg-red-500 hover:bg-red-700 cursor-pointer p-4 rounded-full relative'>
        ...
        <div className='flex justify-center w-1/5 crusor-pointer '>
           {
            food?.payment===false && <span className='font-bold text-sm '>
                Not Paid
            </span>
           }
           {
            food?.payment && <span className='font-bold text-green-600 text-sm '>
                Paid
            </span>
           }
        </div>
