...
import header from "../assets/banner.svg"
const Header = () => {
    return (
            ...
            <div className='container mx-auto py-[14vh]'>
                <div className='grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center'>
                    <div className='lg:w-[32rem] w-full flex flex-col space-y-6'>
                        ...
                        Taste<span className='text-[#f54748]'>Matters

                            </span>Speed<span className='text-[#f54748]'>Delivers </span>-<span className='text-[#Fdc55e]'>Moonlight Cafe</span>
                        </div>
                        <div className='lg:text-xl text-[#191919] md:text-lg text-base'>
                            Moonlight Restaurant offers a celestial dining experience, where soft ambient lighting and refined elegance set the stage.
                            The menu, a symphony of exquisite flavors, features carefully crafted dishes using premium ingredients.
                        ...
                        <div className="flex  gap-8 items-center">
                            ...
                            <div className="sm:flex hidden gap-4 items-center" >
                                <div className="h-14 w-14 shadow-xl cursor-pointer relative bg-white rounded-full" >
                    ...
                    <img src={header} alt='banner' className='h-[30rem] mx-auto justify-end' />
                </div>
            </div>
        </div>
